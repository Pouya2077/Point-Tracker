...
6. As a user, I want to have the option to save my cart and points before I close the application.
7. As a user, I want to have the option to load a save file of the cart and points I had at the store.
